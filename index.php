  ...
  <main>
    ...
    <section id="about" class="content-about-center about-background">
      <div class="container">
        ...
        <div class="row justify-content-center">
          <div class="col-9">
            <p class="text-center">A Bocamaria é uma empresa preocupada em respeitar você e o planeta,
              pensando nisso optamos por trabalhar com produtos naturais e certificados, garantindo assim
              a qualidade dos nossos produtos e a satisfação dos consumidores.
              Nossas embalagens são biodegradáveis pois prezamos pelo meio ambiente e qualidade de vida.
            </p>
          </div>
        </div>
      </div>
